...
#add=========================================
        ...
        for i in range(self.start_level + 1, self.backbone_end_level):#1,2,3
            d_conv = ConvModule(
                out_channels,                         
                out_channels,
                3,
...
#=========================================
        ...
        for i in range(self.start_level, self.backbone_end_level):
            ...
            fpn_conv = ConvModule(
                ...
                inplace=False,
                order=self.order)
            cara_flag = 0 #设置cara标志位
            if cara_flag = 1 and i != self.backbone_end_level - 1:
...
#used_backbone_levels = 4
        ...
        ]   #计算inter_out[] 前级输出  0, 1, 2, 3

        # add bottom-up path
        for i in range(0, used_backbone_levels - 1):#0，1，2
