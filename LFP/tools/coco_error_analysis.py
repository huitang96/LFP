...
def main():
    ...
    parser.add_argument('result', help='result file (jsonopen format) path')
    parser.add_argument('out_dir', help='dir to save analyze result images')
    parser.add_argument(
        '--ann',
        default='./data/coco/annotations/annotations_trainval2017/annotations/instances_val2017.json',
